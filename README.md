...
This is the Readme file of the original sample of the usage of [Battlesnake API](https://docs.battlesnake.com/references/api). This is meant for using the sample.
